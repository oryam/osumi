package com.oryam.service.osumi.common.util.log;
...
public final class LoggingAspect {
    ...
    @Before("@annotation(com.oryam.service.osumi.common.util.log.LogName)")
    ...
    @Around("@annotation(com.oryam.service.osumi.common.util.log.LogTime)")
