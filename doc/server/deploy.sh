...
APP_MAVEN_GROUP_ID=com.oryam.maven.osumi
APP_MAVEN_ARTEFACT_ID=osumi-application
APP_MAVEN_CURRENT_VERSION=0.0.1-SNAPSHOT
APP_MAVEN_PACKAGE=jar
APP_MAVEN_BIN_NAME=osumi-application.jar
APP_MAVEN_BIN_DEST=$APP_BACKEND/$APP_MAVEN_BIN_NAME



# Use user account
echo Connect as osumi to run this script
